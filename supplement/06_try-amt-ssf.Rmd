...
# sample it every 10m
steps$geometry = st_line_sample(steps$geometry, density = 1 / 10)

# remake to line
steps$geometry = st_cast(steps$geometry, "LINESTRING")

# THIS CAN NOW BE PASSED TO VELOX, MAKE SF FIRST

# # make sf all around
# ndvi_path = vapply(steps$geometry[1:10], function(x) {
