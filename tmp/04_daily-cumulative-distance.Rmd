...
# order data by time
data <- lapply(data, setorderv, "UNIX")
...
data_dist_summary <- data_dist_summary[treat != "LongPeriod"]
...
# save as figure
ggsave(
  filename = "figures/fig_rrv_total_distance.png",
  height = 4, width = 4.5
)
```
