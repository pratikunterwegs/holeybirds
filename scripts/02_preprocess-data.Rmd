...
smoothed_speed_threshold = 15
point_speed_threshold = 10
...
for (file in files) {
    ...
    if (nrow(df) > min_rows) {
      ...
      df <- df[!is.na(speed_smoothed) & 
                 speed_smoothed < smoothed_speed_threshold, ]
      print(
      ...
      df <- df[speed_in < point_speed_threshold & 
                 speed_out < point_speed_threshold, ]
      print(
      ...
      save_file = glue("data/processed/data_preprocessed/data_smooth\\
      ...
      # save data to file
      save_file = glue("data/processed/data_preprocessed/data_thin\\
                       _{species}_{treatment}_{tag_id}.csv")
      print(
      ...
      print(
        glue("-- saved to data/processed/data_preprocessed/
              data_thin_{species}_{treatment}_{tag_id}.csv
             ")
      )
      ...
      print(
        glue("Too few rows (< {min_rows}) remaining
